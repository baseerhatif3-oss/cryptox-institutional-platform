          ...
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-20 items-center">
            ...
            <div>
              ...
              <p className="text-zinc-400 text-2xl leading-relaxed mb-12 max-w-2xl">
                ...
                Institutional-grade cryptocurrency trading ecosystem with advanced analytics, portfolio management, and enterprise infrastructure.
              ...
              <div className="flex flex-col sm:flex-row gap-5">
                ...
                <a
                  href="/register"
                  className="bg-yellow-400 hover:bg-yellow-300 transition-all text-black px-10 py-5 rounded-3xl font-black text-xl text-center shadow-2xl shadow-yellow-400/20"
                >
